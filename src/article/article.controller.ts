...
export class ArticleController {
    ...
    @Post('create')
    create(@Body() body: ArticleCreateDto, @ReqUser() user: User) {
    ...
    @APIResponse(ArticleDto)
    @Post('update')
    update(@Body() body: ArticleUpdateDto, @ReqUser() user: User) {
    ...
    @APIResponse()
    @Post('remove')
    remove(@Body() body: ArticleIdDto, @ReqUser() user: User) {
    ...
    @APIResponse()
    @Post('delete')
    delete(@Body() body: ArticleIdDto, @ReqUser() user: User) {
    ...
    @Post('detail')
    getArticle(@Body() body: ArticleIdDto, @ReqUser() user: User) {
    ...
    @APIResponse(ArticleDetalDto)
    @Post('detail_ex')
    getArticleEx(@Body() body: ArticleIdDto, @ReqUser() user: User) {
    ...
    @APIResponse()
    @Post('collect')
    collect(@Body() body: ArticleCollectDto, @ReqUser() user: User) {
    ...
    @APIResponse()
    @Post('collect_ex')
    collectEx(@Body() body: ArticleCollectDto, @ReqUser() user: User) {
    ...
    @Post('query')
    query(@Body() body: ArticleQueryDto, @ReqUser() user: User) {
    ...
    @APIResponse([ArticleDto], true)
    @Get('query_time')
    queryByTime(@Query() params: ArticleTimeDto) {
        return this.articleService.queryByTime(params.datetime);
    }

    @ApiOperation({
        summary: '测试子查询(查找作者年龄大于40岁的)',
    })
    @Public()
    @APIResponse()
    @Post('sub_query_by_age')
    subQueryByAge() {
        return this.articleService.subQueryByAge();
    }
}
